...
if appt_type == "หัตถการ":
    proc_type = st.selectbox(
        "🔧 ประเภทหัตถการ",
        ["เจาะเลือด", "ผ่าตัดเล็ก", "ทำแผล", "ทำแผล/ตัดไหม", "นัดพ่นยา", "นัดให้ยาฆ่าเชื้อต่อเนื่อง"]
    )
    ...
    else:  # นัดให้ยาฆ่าเชื้อต่อเนื่อง
        act_th = "ให้ยาฆ่าเชื้อต่อเนื่อง"
        act_en = "Continuous Antibiotic Administration"
        ins_th = "มาตรงตามวันและเวลานัดทุกครั้งเพื่อให้ยาครบตามแผนการรักษา ห้ามขาดนัด หากมีไข้ ผื่น บวมแดง หรือแพ้ยา ให้รีบแจ้งเจ้าหน้าที่ทันที และนำยา/ใบนัดเดิมมาด้วยทุกครั้ง"
        ins_en = "Come on the exact date and time for every dose to complete the treatment plan; do not miss appointments. If you develop fever, rash, swelling, or signs of drug allergy, inform staff immediately. Bring your medications/appointment card every visit"
